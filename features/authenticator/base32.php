 ...
 * Base32.
 *
 * Follows the RFC 4648 data encoding schemes.
 *
 * @since 1.0.0
 */
class Base32 {
	/**
	 * Letter map reference.
	 *
	 * @var array $map Letter map reference.
	 *
	 * @since 1.0.0
	 */
	...
	/**
	 * Reference letter to number.
	 *
	 * @var array $flippedMap Flipped letter map reference.
	 *
	 * @since 1.0.0
	 */
	 ...
	 *
	 * Reminder on setting "padding" to false when encoding URLs.
	 *
	 * @param string $input String with allowed characters.
	 * @param bool $padding Add padding characters.
	 *
	 * @return string
	 *
	 * @since 1.0.0
	 ...
	 * @since 1.0.0
	 */
	public static function decode( string $input ): bool|string|null {
		if ( empty( $input ) ) {
			return null;
		}
